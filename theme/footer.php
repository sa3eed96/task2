		...
		<div class="container">
			<div class="pt-50 pb-20 pos-relative">
				<div class="abs-tblr pt-50 z--1 text-center">
					<div class="h-80 pos-relative"><img class="opacty-1 h-100 w-auto" src="wp-content/themes/theme/images/map.png" alt=""></div>
				</div>
				<div class="row">
				
					<div class="col-sm-4">
						<div class="mb-30">
							<a href="#"><img src="wp-content/themes/theme/images/logo-white.png"></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="wp-content/themes/theme/plugin-frameworks/jquery-3.2.1.min.js"></script>
	
	<script src="wp-content/themes/theme/plugin-frameworks/tether.min.js"></script>
	
	<script src="wp-content/themes/theme/plugin-frameworks/bootstrap.js"></script>
	
	<script src="wp-content/themes/theme/scripts.js"></script>
	<?php wp_footer();?>
